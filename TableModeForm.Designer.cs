...
namespace Planetoid_DB
{
  partial class TableModeForm
  {
    ...
    private void InitializeComponent()
    {
			...
			// progressBar
			// 
			this.progressBar.AccessibleDescription = "Shows the progress";
			...
			this.progressBar.Size = new System.Drawing.Size(720, 19);
			this.progressBar.Step = 1;
			this.progressBar.Style = System.Windows.Forms.ProgressBarStyle.Continuous;
			this.progressBar.TabIndex = 7;
			this.toolTip.SetToolTip(this.progressBar, "Shows the progress");
			...
			// labelMinimum
			// 
			this.labelMinimum.AccessibleDescription = "Shows the minimum";
			...
			this.labelMinimum.DoubleClick += new System.EventHandler(this.CopyToClipboard_DoubleClick);
			...
			// 
			this.numericUpDownMinimum.AccessibleDescription = "Shows the minimum value";
			...
			// 
			this.numericUpDownMaximum.AccessibleDescription = "Shows the maximum value";
			...
			// labelMaximum
			// 
			this.labelMaximum.AccessibleDescription = "Shows the maximum";
			...
			this.labelMaximum.DoubleClick += new System.EventHandler(this.CopyToClipboard_DoubleClick);
			...
			// buttonList
			// 
			this.buttonList.AccessibleDescription = "Starts the progress and list";
			...
			// labelWarning
			// 
			this.labelWarning.AccessibleDescription = "Warning message: Be careful: do not use large ranges between minimum and maximum!" +
    " This can increase loading time and memory. Use small spans!";
			...
			this.labelWarning.Size = new System.Drawing.Size(308, 39);
			this.labelWarning.TabIndex = 6;
			this.labelWarning.Text = "Be careful: do not use large ranges between minimum and maximum! This can increas" +
    "e loading time and memory. Use small ranges!";
			this.labelWarning.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.toolTip.SetToolTip(this.labelWarning, "Be careful: do not use large ranges between minimum and maximum! This can increas" +
        "e loading time and memory. Use small spans!");
			this.labelWarning.DoubleClick += new System.EventHandler(this.CopyToClipboard_DoubleClick);
			...
			// listViewTableMode
			// 
			this.listViewTableMode.AccessibleDescription = "Shows the list with the items";
			...
			this.panel.Controls.Add(this.labelMinimum);
			this.panel.Controls.Add(this.buttonCancel);
			this.panel.Controls.Add(this.listViewTableMode);
			this.panel.Controls.Add(this.labelWarning);
			this.panel.Controls.Add(this.progressBar);
			this.panel.Controls.Add(this.buttonList);
			this.panel.Controls.Add(this.numericUpDownMinimum);
			this.panel.Controls.Add(this.numericUpDownMaximum);
			this.panel.Controls.Add(this.labelMaximum);
			this.panel.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panel.Location = new System.Drawing.Point(0, 0);
			this.panel.Name = "panel";
			this.panel.PanelBackStyle = Krypton.Toolkit.PaletteBackStyle.FormMain;
			this.panel.Size = new System.Drawing.Size(744, 415);
			...
			// TableModeForm
			// 
			this.AccessibleDescription = "Lists the MPCORB.DAT into a  table";
			...
			this.toolTip.SetToolTip(this, "Table Mode");
