...
namespace Planetoid_DB
{
	...
	public partial class SearchForm : KryptonForm
	{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonMarkAll_Click(object sender, EventArgs e)
		{
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonUnmarkAll_Click(object sender, EventArgs e)
		{
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonOpen_Click(object sender, EventArgs e)
		{
		}
