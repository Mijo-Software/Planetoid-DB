...
namespace Planetoid_DB
{
	...
	public partial class ExportDataSheetForm : KryptonForm
	{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonExportAsTxt_Click(object sender, EventArgs e)
		{
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonExportAsHtml_Click(object sender, EventArgs e)
		{
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonExportAsXml_Click(object sender, EventArgs e)
		{
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void KryptonButtonExportAsJson_Click(object sender, EventArgs e)
		{
		}
