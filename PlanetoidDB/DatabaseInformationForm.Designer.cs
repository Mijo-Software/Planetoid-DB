namespace PlanetoidDB
{
  partial class DatabaseInformationForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.labelDateCreated.TabIndex = 3;
      ...
      this.labelDateAccessed.TabIndex = 4;
      ...
      this.labelDateWrited.TabIndex = 5;
      ...
      this.labelDirectoryValue.TabIndex = 8;
      ...
      this.labelDateCreatedValue.TabIndex = 10;
      ...
      this.labelDateAccessedValue.TabIndex = 11;
      ...
      this.labelDateWritedValue.TabIndex = 12;
